...
static void __ref do_deferred_initcall(struct work_struct *work)
{
	initcall_t *fn;
...
static DECLARE_WORK(deferred_initcall_work, do_deferred_initcall);

static void __init do_deferred_initcalls(void)
{
